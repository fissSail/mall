package com.yff.mall.mallseckill.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        boolean match = new AntPathMatcher().match("/currentSeckillSkus", requestURI);
        boolean match1 = new AntPathMatcher().match("/sku/seckill/*", requestURI);
        if (match || match1) {
            return true;
        }
